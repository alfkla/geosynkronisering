...
.\config.cmd --environment --environmentname "testservers" --agent $env:COMPUTERNAME --runasservice --work '_work' --url 'https://dev.azure.com/norkart-tfs/' --projectname 'WinGIS_QMS' --auth PAT --token j2dmvaXXXXXXX7yrij67mkvq;
